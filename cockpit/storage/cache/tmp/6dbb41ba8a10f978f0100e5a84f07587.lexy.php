...
<div data-ng-controller="gallery" data-id="<?php echo  $id ; ?>" ng-cloak>
    ...
    <div id="meta-dialog" class="uk-modal" ng-if="modalOpen">
        <div class="uk-modal-dialog">
            ...
            <h3><?php echo $app("i18n")->get('Meta'); ?> for <b>{{ metaimage.path | filename }}</b></h3>
            ...
            <button class="uk-button uk-modal-close" ng-click="hideMeta()"><?php echo $app("i18n")->get('Close'); ?></button>
        </div>
    </div>
