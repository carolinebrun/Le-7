                ...
                <div class="app-panel">
                    ...
                    <div class="app-panel-box docked-bottom uk-text-center">
                        ...
                        <ul class="uk-subnav uk-subnav-line uk-flex-center mm-actions">
                            ...
                            <li ng-if="(file.ext == 'zip')"><a ng-click="action('unzip', file)" title="<?php echo $app("i18n")->get('Unzip file'); ?>"><i class="uk-icon-archive"></i></a></li>
                       ...
                       <div class="mm-actions" data-uk-dropdown="{mode:'click'}">
                           ...
                           <div class="uk-dropdown uk-dropdown-flip uk-text-left">
                               <ul class="uk-nav uk-nav-dropdown uk-nav-parent-icon">
                                   ...
                                   <li ng-if="(file.ext == 'zip')"><a ng-click="action('unzip', file)" title="<?php echo $app("i18n")->get('Unzip file'); ?>"><i class="uk-icon-archive"></i> <?php echo $app("i18n")->get('Unzip file'); ?></a></li>
                                   <li class="uk-nav-divider"></li>
