        ...
        <div class="app-wrapper">
                        ...
                        <ul class="uk-nav uk-nav-navbar uk-nav-parent-icon">
                            <li>
                                <a href="<?php $app->route('/accounts/account'); ?>" class="uk-clearfix">
                                    <img class="uk-rounded uk-float-left uk-margin-right" src="//www.gravatar.com/avatar/<?php echo  md5($app['user']['email']) ; ?>?d=mm&s=40" width="40" height="40" alt="avatar">
            ...
            <div class="uk-navbar-flip">
                ...
                <ul class="uk-navbar-nav app-top-navbar-links">
                    ...
                    <li class="<?php echo  (isset($item["active"]) && $item["active"]) ? 'uk-active':'' ; ?>" <?php echo  (isset($item["children"]) && count($item["children"])) ? 'data-uk-dropdown':'' ; ?>>
                            ...
                            <div class="uk-dropdown uk-dropdown-navbar">
                                ...
                                <?php foreach($item["children"] as $child) { ?>
                                    <?php if(isset($child["header"])) { ?>
                                        <li class="uk-nav-header uk-text-truncate"><?php echo  $child["header"] ; ?></li>
                                    <?php } ?>
